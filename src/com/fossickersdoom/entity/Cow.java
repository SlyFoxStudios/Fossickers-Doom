...
public class Cow extends Mob
{
    ...
    public void render(final Screen screen) {
        ...
        int col0 = Color.get(-1, 0, 222, 211);
        int col2 = Color.get(-1, 0, 333, 322);
        int col3 = Color.get(-1, 0, 222, 211);
        int col4 = Color.get(-1, 0, 111, 100);
        int col5 = Color.get(-1, 0, 333, 322);
        if (this.isLight()) {
            col0 = Color.get(-1, 0, 333, 322);
            col2 = Color.get(-1, 0, 333, 322);
            col3 = Color.get(-1, 0, 333, 322);
            col4 = Color.get(-1, 0, 333, 322);
            col5 = Color.get(-1, 0, 333, 322);
        }
        else {
            col0 = Color.get(-1, 0, 222, 211);
            col2 = Color.get(-1, 0, 333, 322);
            col3 = Color.get(-1, 0, 222, 211);
            col4 = Color.get(-1, 0, 111, 100);
            col5 = Color.get(-1, 0, 333, 322);
        }
    ...
    protected void die() {
        ...
        if (StartMenu.diff == StartMenu.easy) {
            ...
            for (int i = 0; i < count; ++i) {
                this.level.add(new ItemEntity(new ResourceItem(Resource.leather), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
            }
            for (int i = 0; i < count; ++i) {
                this.level.add(new ItemEntity(new ResourceItem(Resource.rawbeef), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
            }
        ...
        if (StartMenu.diff == StartMenu.hard) {
            final int count = this.random.nextInt(1);
            for (int i = 0; i < count; ++i) {
                this.level.add(new ItemEntity(new ResourceItem(Resource.leather), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
            }
            for (int i = 0; i < count; ++i) {
