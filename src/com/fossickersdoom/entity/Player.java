...
import com.fossickersdoom.saveload.Save;
...
import com.fossickersdoom.screen.CraftInvMenu;
import com.fossickersdoom.screen.HomeMenu;
import com.fossickersdoom.screen.InfoMenu;
import com.fossickersdoom.screen.InventoryMenu;
import com.fossickersdoom.screen.LevelTransitionMenu;
import com.fossickersdoom.screen.LoadingMenu;
import com.fossickersdoom.screen.ModeMenu;
import com.fossickersdoom.screen.PauseMenu;
import com.fossickersdoom.screen.PlayerInfoMenu;
...
public class Player extends Mob {
    ...
    public Player(Game game, InputHandler input) {
        ...
        if(ModeMenu.creative) {
            ...
            this.inventory.add(new ToolItem(ToolType.claymore, 1));
        }
    ...
    public void render(Screen screen) {
        ...
        this.col1 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
        int r2 = this.r - 50;
        int b2 = this.b - 50;
        int g2 = this.g - 50;
        ...
        this.col2 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
        this.col3 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
        this.col4 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
        if(this.isLight()) {
            this.col0 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));//TODO HERE
            this.col1 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
            this.col2 = Color.get(-1, Color.rgb(22, 47, 114), Color.rgb(0, 182, 225), Color.rgb(221, 183, 160));
