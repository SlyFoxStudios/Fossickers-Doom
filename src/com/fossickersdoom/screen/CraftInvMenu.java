...
public class CraftInvMenu extends Menu
{
    ...
    public CraftInvMenu(final List<Recipe> recipes, final Player player) {
        this.selected = 0;
    ...
    public void render(final Screen screen) {
        Font.rendercraftFrame(screen, "Have", 17, 1, 24, 3);
        Font.rendercraftFrame(screen, "Cost", 17, 4, 24, 11);
        Font.rendercraftFrame(screen, "Crafting", 0, 1, 16, 11);
