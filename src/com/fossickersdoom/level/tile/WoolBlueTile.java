...
{
    public WoolBlueTile(final int id) {
        super(id);
    }
    
    @Override
    public void render(final Screen screen, final Level level, final int x, final int y) {
        final int col0 = Color.get(13, 125, 13, 125);
        final int col2 = Color.get(13, 115, 13, 115);
        final int col3 = Color.get(12, 13, 12, 13);
        final int col4 = Color.get(0, 13, 0, 13);
        final int col5 = Color.get(13, 115, 13, 115);
