...
{
    public WoolTile(final int id) {
        super(id);
    }
    
    @Override
    public void render(final Screen screen, final Level level, final int x, final int y) {
        final int col0 = Color.get(333, 222, 333, 444);
        final int col2 = Color.get(444, 333, 444, 555);
        final int col3 = Color.get(333, 222, 333, 444);
        final int col4 = Color.get(222, 111, 222, 333);
        final int col5 = Color.get(444, 333, 444, 555);
