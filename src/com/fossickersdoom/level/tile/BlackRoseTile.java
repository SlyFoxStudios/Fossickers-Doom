...
public class BlackRoseTile extends GrassTile
{
    public int col0;
    public int col1;
    public int col2;
    ...
    public BlackRoseTile(final int id) {
        super(id);
        this.col0 = Color.get(20, 131, 000, 500);
        this.col1 = Color.get(10, 141, 000, 500);
        this.col2 = Color.get(10, 30, 000, 500);
        this.col3 = Color.get(0, 20, 000, 500);
        BlackRoseTile.tiles[id] = this;
    ...
    public boolean interact(final Level level, final int x, final int y, final Player player, final Item item, final int attackDir) {
        if (item instanceof ToolItem) {
            ...
            if (tool.type == ToolType.shovel && player.payStamina(2 - tool.level)) {
                level.add(new ItemEntity(new ResourceItem(Resource.brose), x * 16 + this.random.nextInt(10) + 3, y * 16 + this.random.nextInt(10) + 3));
