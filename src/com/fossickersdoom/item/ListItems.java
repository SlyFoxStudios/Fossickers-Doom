...
public class ListItems
{
    ...
    static {
        ListItems.items = new ArrayList<Item>();
    }
    
    public ListItems() {
        this.spawnerzombie = new FurnitureItem(new Spawner(new Zombie(1), 1)).addItem();
        this.spawnerslime = new FurnitureItem(new Spawner(new Slime(1), 1)).addItem();
        this.spawnerknight = new FurnitureItem(new Spawner(new Knight(1), 1)).addItem();
        this.spawnersnake = new FurnitureItem(new Spawner(new Snake(1), 1)).addItem();
        this.spawnerskeleton = new FurnitureItem(new Spawner(new Skeleton(1), 1)).addItem();
        this.spawnercreeper = new FurnitureItem(new Spawner(new Creeper(1), 1)).addItem();
        this.spawnerairwizard = new FurnitureItem(new Spawner(new AirWizard(false), 1)).addItem();
        this.spawnerairwizardii = new FurnitureItem(new Spawner(new AirWizard(true), 1)).addItem();
        this.spawnerpig = new FurnitureItem(new Spawner(new Pig(1), 1)).addItem();
        this.spawnersheep = new FurnitureItem(new Spawner(new Sheep(1), 1)).addItem();
    ...
    public static Item getItem(String name) {
        ...
        if (!name.equals("")) {
            ...
            for (int i = 0; i < ListItems.items.size(); ++i) {
                if (ListItems.items.get(i).getName().equals(name)) {
                    newItem = ListItems.items.get(i);
                    return newItem;
                }
            }
        }
