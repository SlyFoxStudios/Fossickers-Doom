...
public class Sheep extends Mob
{
    ...
    public void render(final Screen screen) {
        ...
        int col0 = Color.get(-1, 0, 444, 321);
        int col2 = Color.get(-1, 0, 555, 432);
        int col3 = Color.get(-1, 0, 333, 210);
        int col4 = Color.get(-1, 0, 222, 100);
        int col5 = Color.get(-1, 0, 444, 432);
        if (this.isLight()) {
            col0 = Color.get(-1, 0, 555, 432);
            col2 = Color.get(-1, 0, 555, 432);
            col3 = Color.get(-1, 0, 555, 432);
            col4 = Color.get(-1, 0, 555, 432);
            col5 = Color.get(-1, 0, 555, 432);
        }
        else {
            col0 = Color.get(-1, 0, 444, 321);
            col2 = Color.get(-1, 0, 555, 432);
            col3 = Color.get(-1, 0, 333, 210);
            col4 = Color.get(-1, 0, 222, 100);
            col5 = Color.get(-1, 0, 444, 432);
        }
