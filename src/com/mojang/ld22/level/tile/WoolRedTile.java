...
{
    public WoolRedTile(final int id) {
        super(id);
    }
    
    @Override
    public void render(final Screen screen, final Level level, final int x, final int y) {
        final int col0 = Color.get(300, 400, 300, 400);
        final int col2 = Color.get(400, 500, 400, 500);
        final int col3 = Color.get(300, 400, 300, 400);
        final int col4 = Color.get(200, 300, 200, 300);
        final int col5 = Color.get(500, 400, 500, 400);
