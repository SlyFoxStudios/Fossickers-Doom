...
public class LevelGen {
        ...
        for(count = 0; count < w * h / 400; ++count) {
            ...
            for(yy = 0; yy < 30; ++yy) {
                ...
                if(var23 >= 0 && yy1 >= 0 && var23 < w && yy1 < h && map[var23 + yy1 * w] == Tile.grass.id) {
                    ...
                    data[var23 + yy1 * w] = (byte)(var22 + random.nextInt(4) * 16);
                }
            }
        }
            ...
            for(i = 0; i < w * h / 150; ++i) {
                ...
                for(yy = 0; yy < 30; ++yy) {
                    ...
                    if(var36 >= var33 && yy1 >= var33 && var36 < w - var33 && yy1 < h - var33 && map[var36 + yy1 * w] == Tile.rock.id) {
                        map[var36 + yy1 * w] = (byte)((Tile.ironOre.id & 255) + depth - 1);
                    }
                }
                ...
                for(yy = 0; yy < 7; ++yy) {
                    ...
                    if(var36 >= var33 && yy1 >= var33 && var36 < w - var33 && yy1 < h - var33 && map[var36 + yy1 * w] == Tile.rock.id) {
                        map[var36 + yy1 * w] = (byte)(Tile.lapisOre.id & 255);
                    }
                }
            }
        } else {
            ...
            for(i = 0; i < w * h / 380; ++i) {
                for(x = 0; x < 10; ++x) {
                    ...
                    if(var35 >= var33 && var37 >= var33 && var35 < w - var33 && var37 < h - var33) {
                        map[var35 + var37 * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 1 + var37 * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + (var37 + 1) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 2 + var37 * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + (var37 + 2) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 3 + var37 * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + (var37 + 3) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 4 + var37 * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + (var37 + 4) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 4 + (var37 + 1) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 4 + (var37 + 2) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 4 + (var37 + 3) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 4 + (var37 + 4) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 3 + (var37 + 1) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 3 + (var37 + 2) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 3 + (var37 + 3) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 3 + (var37 + 4) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 2 + (var37 + 1) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 2 + (var37 + 2) * w] = (byte)(Tile.stairsDown.id & 255);
                        map[var35 + 2 + (var37 + 3) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 2 + (var37 + 4) * w] = (byte)(Tile.ow.id & 255);
                        map[var35 + 1 + (var37 + 1) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 1 + (var37 + 2) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 1 + (var37 + 3) * w] = (byte)(Tile.o.id & 255);
                        map[var35 + 1 + (var37 + 4) * w] = (byte)(Tile.ow.id & 255);
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            short w = 128;
            short h = w;
            byte[] map = createAndValidateUndergroundMap(w, w, d++ % 3 + 1)[0];
